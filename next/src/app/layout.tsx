...
export const metadata: Metadata = {
  ...
  description: '小さなお店で出会った可愛い雑貨や、ふらっと立ち寄ったカフェでつい買ってしまった美味しそうなお菓子...旅先では、どこでどんなお土産との出会いがあるかわかりません。そんな出会い一つ一つを記録して、あなただけの思い出コレクションを作りましょう。新しいお土産との出会いもきっと見つかるはず！',
